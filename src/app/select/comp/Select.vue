...
<template>
  ...
  <span class="selected-tag" v-for="option in valueAsArray" @click="presClicked()" v-bind:key="option.index">
...
<button v-if="multiple" @click="deselect(option)" type="button" class="close" aria-label="Remove option">
  <span aria-hidden="true">&times;</span>
            ...
            <input
                    ...
                    @focus="onSearchFocus"
                    type="search"
                    v-bind:class="{ 'form-control': true, 'small-input': !open && isSelected }"
            ...
            <i v-if="!noDrop" ref="openIndicator" role="presentation" @click="presClicked()" class="open-indicator"></i>
